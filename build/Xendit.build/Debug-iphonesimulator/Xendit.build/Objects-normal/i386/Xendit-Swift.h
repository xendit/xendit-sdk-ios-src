...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Xendit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (BOOL)isCvnValidForCardTypeWithCreditCardCVN:(NSString * _Nonnull)creditCardCVN cardNumber:(NSString * _Nonnull)cardNumber SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
