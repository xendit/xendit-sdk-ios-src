...
//            XCTAssertEqual(token?.metadata?.bank, "Test bank")
//            XCTAssertEqual(token?.metadata?.type, "CREDIT")
//            XCTAssertEqual(token?.metadata?.countryCode, "ID")
//            XCTAssertEqual(token?.metadata?.brand, "VISA")
//        }
//    }
//
